...
<main class="property-feed" id="property-list">
            <div class="fb-card" data-aos="fade-up" data-property-id="695">
            ...
            <div class="fb-card-header">
                ...
                <div class="fb-header-info">
                    ...
                    <p><i class="fa-regular fa-clock"></i> March 16, 2026</p>
                </div>
                <div class="fb-status-badge">FOR_LEASE</div>
            </div>

            <!-- Image Gallery -->
            <div class="fb-image-gallery" onclick="openLightbox(695, 0)">
                <div class="gallery-main">
                    <img src="uploads/realty/realty_69b777027be4e7.00618512.png" alt="Virtual Office">
                                        <div class="gallery-badge">
                        <i class="fa-regular fa-images"></i> 4 photos
                    </div>
                                    </div>
                
                                <div class="gallery-thumbnails">
                                        <div class="thumb-item" onclick="event.stopPropagation(); openLightbox(695, 1)">
                        <img src="uploads/realty/realty_69b777027c2e46.04999990.png" alt="Thumbnail">
                                            </div>
                                        <div class="thumb-item" onclick="event.stopPropagation(); openLightbox(695, 2)">
                        <img src="uploads/realty/realty_69b777027c7ff6.85569097.png" alt="Thumbnail">
                                            </div>
                                        <div class="thumb-item" onclick="event.stopPropagation(); openLightbox(695, 3)">
                        <img src="uploads/realty/realty_69b777027cc477.91281107.png" alt="Thumbnail">
                                            </div>
                                    </div>
                            </div>
            ...
            <div class="fb-card-body">
                <div class="fb-price">per month 2,899.00</div>
                <div class="fb-title">Alpha Premier Virtual Office Solutions (Ortigas)</div>
                <div class="fb-location">
                    <i class="fa-solid fa-location-dot"></i> Tektite Building, Ortigas Center, Pasig City                </div>

                <!-- Rating Section -->
                <div class="fb-rating">
                    <div class="fb-stars" data-property-id="695">
                                                <i class="fa-solid fa-star " data-val="5" onclick="rateProperty(695, 5, this)"></i>
                                                <i class="fa-solid fa-star " data-val="4" onclick="rateProperty(695, 4, this)"></i>
                                                <i class="fa-solid fa-star " data-val="3" onclick="rateProperty(695, 3, this)"></i>
                                                <i class="fa-solid fa-star " data-val="2" onclick="rateProperty(695, 2, this)"></i>
                                                <i class="fa-solid fa-star " data-val="1" onclick="rateProperty(695, 1, this)"></i>
                                            </div>
                    <span class="rating-text" id="rating-695">1.7</span>
                </div>

                <!-- Specifications -->
                <div class="fb-specs">
                    <span><i class="fa-solid fa-ruler-combined"></i> Floor: — sqm</span>
                    <span><i class="fa-solid fa-maximize"></i> Lot: — sqm</span>
                </div>

                <!-- Description -->
                <div class="fb-description collapsed" id="desc-695">
                    🚀 Elevate Your Business with Alpha Premier Realty’s Virtual<br />
Office Solutions! Perfect for entrepreneurs, startups, and<br />
professionals who want a strong business presence without the<br />
high overhead.<br />
<br />
📌Choose the Plan That Fits You:<br />
💼 Premier Access – ₱2,899<br />
🏢 Premier Prestige – ₱3,499<br />
🌟 Alpha Premier – ₱4,999<br />
⚙️ Custom Solutions – Tailored to your needs<br />
<br />
✨ What You Get:<br />
📍 Prestigious Ortigas Business Address<br />
📬 Mail Handling &amp; Reception Services<br />
🤝 Access to Meeting Rooms &amp; Co-Working Spaces (per plan)<br />
📺 Digital Signage for Your Brand<br />
⚡ High-Speed Internet &amp; Utilities<br />
💡 Flexible. Professional. Designed to help your business grow.<br />
<br />
📲 For Inquiries &amp; Viewing Appointments: Alpha Premier Realty<br />
✉️ realty@alphapremiergroup.com<br />
📞 • 0927-555-5803 • 0915-88 8-9482 • 0921-217-4555                </div>
                                <button class="see-more-btn" onclick="toggleDescription(695)">See More</button>
                
                <!-- Reaction Bar -->
                <div class="fb-reaction-bar">
                    <button class="reaction-btn " onclick="toggleLike(695, this)">
                        <i class="fa-regular fa-heart"></i>
                        Like <span class="reaction-count" id="likes-695">4</span>
                    </button>
                    <button class="reaction-btn" onclick="focusComment(695)">
                        <i class="fa-regular fa-comment"></i> Comment
                    </button>
                </div>

                <!-- Comments Section -->
                <div class="fb-comments" id="comments-695">
                    <div class="comment-input-area">
                        <input type="text" id="comment-input-695" placeholder="Write a comment..." maxlength="500">
                        <button onclick="postComment(695)">Post</button>
                    </div>
                    <div class="comment-list" id="comment-list-695">
                            ...
                            <div class="comment-content">
                                <div class="comment-header">
                                    ...
                                    <span class="comment-date">Mar 30, 2026</span>
                                </div>
                                <p>Wow</p>
                            </div>
                        </div>
                ...
                <button type="button" class="fb-action-btn view-btn open-modal-btn" style="width:100%; margin-top:15px; padding:12px; background:var(--accent); color:#000; border:none; border-radius:8px; font-weight:600; cursor:pointer;"
                    data-title="Alpha Premier Virtual Office Solutions (Ortigas)"
                    data-price="per month 2,899.00"
                    data-loc="Tektite Building, Ortigas Center, Pasig City"
                    data-status="FOR_LEASE"
                    data-floor="—"
                    data-lot="—"
                    data-desc="🚀 Elevate Your Business with Alpha Premier Realty’s Virtual
Office Solutions! Perfect for entrepreneurs, startups, and
professionals who want a strong business presence without the
high overhead.

📌Choose the Plan That Fits You:
💼 Premier Access – ₱2,899
🏢 Premier Prestige – ₱3,499
🌟 Alpha Premier – ₱4,999
⚙️ Custom Solutions – Tailored to your needs

✨ What You Get:
📍 Prestigious Ortigas Business Address
📬 Mail Handling &amp; Reception Services
🤝 Access to Meeting Rooms &amp; Co-Working Spaces (per plan)
📺 Digital Signage for Your Brand
⚡ High-Speed Internet &amp; Utilities
💡 Flexible. Professional. Designed to help your business grow.

📲 For Inquiries &amp; Viewing Appointments: Alpha Premier Realty
✉️ realty@alphapremiergroup.com
📞 • 0927-555-5803 • 0915-88 8-9482 • 0921-217-4555"
                    data-imgs="uploads/realty/realty_69b777027be4e7.00618512.png,uploads/realty/realty_69b777027c2e46.04999990.png,uploads/realty/realty_69b777027c7ff6.85569097.png,uploads/realty/realty_69b777027cc477.91281107.png">
        ...
        <div id="images-695" style="display:none;">uploads/realty/realty_69b777027be4e7.00618512.png,uploads/realty/realty_69b777027c2e46.04999990.png,uploads/realty/realty_69b777027c7ff6.85569097.png,uploads/realty/realty_69b777027cc477.91281107.png</div>
